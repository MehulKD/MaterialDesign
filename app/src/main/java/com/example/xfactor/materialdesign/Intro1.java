 ...
 * {@link Intro1.OnFragmentInteractionListener} interface
...
public class Intro1 extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
      //  Fontain.init(getActivity(), "orangejuice", "orangejuice");
   ...
   private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Typeface font = Typeface.createFromAsset(getActivity().getAssets(), "fonts/orange juice.ttf");
