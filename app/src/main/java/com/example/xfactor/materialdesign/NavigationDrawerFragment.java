...
//    public NavigationDrawerFragment(ArrayList<header> headers) {
...
//        blah = savedInstanceState.getString("Key");
...
//    public NavigationDrawerFragment(String username, String email) {
//        this.username = username;
//        Log.d("NAV", "" + this.username);
////        SharedPreferences preferences = getActivity().getSharedPreferences("ORE",Context.MODE_PRIVATE);
////        SharedPreferences.Editor editor = preferences.edit();
////        editor.putString("as",this.username);
////        editor.apply();
////        Bundle bundle = new Bundle();
////        bundle.putString("N",this.username);
//        this.email = email;
//        Log.d("NAV", "" + this.email);
 //   }
...
//        blah = getArguments().getString("Key");
//        SharedPreferences preferences = getActivity().getSharedPreferences("ORE",Context.MODE_PRIVATE);
//        String val = preferences.getString("as","");
        Bundle args = getArguments();
//        username=args.getString("a");
        Log.d("user",""+username);
  //      email = args.getString("b");
        recyclerView = (RecyclerView) layout.findViewById(R.id.recylerview);
        adapter = new Adapter(getActivity(), getdata(), username, email);
...
//                        view.setBackgroundColor(BlueColorValue);
    ...
    public static NavigationDrawerFragment newInstance(String a , String b) {
